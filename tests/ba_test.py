    ...
    def setUpClass(cls):
        ...
        cls.test_cases = [
            ...
            },
            {
                ...
                "extra_args": ["-egraphml", "--export_output_folder", cls.output_dir, "--digestion", "skip", "-sg", "-sst", "A", "-of", "JKBAAA_peptide"],
            },
            {
                ...
                "extra_args": ["-egraphml", "--export_output_folder", cls.output_dir, "--digestion", "skip", "-sg", "-sst", "B", "-of", "JKBAAB_single"],
            },
            {
                ...
                "extra_args": ["-egraphml", "--export_output_folder", cls.output_dir, "--digestion", "skip", "-sg", "-sst", "AB", "-sst", "BC", "-of", "JKBAAB_overlapping"],
            },
            {
                ...
                "extra_args": ["-egraphml", "--export_output_folder", cls.output_dir, "--digestion", "skip", "-sg", "-sst", "B", "-sst", "ABC", "-of", "JKBAAB_children"],
            },
            {
                ...
                "extra_args": ["-egraphml", "--export_output_folder", cls.output_dir, "--digestion", "skip", "-sg", "-sst", "AVC", "-of", "JKBAAC_spanning"],
            },
        ]
